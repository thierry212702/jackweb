      ...
      <section className="relative bg-[#1a1a1a] text-white py-28 lg:py-36">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl lg:text-5xl xl:text-6xl leading-tight mb-6" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Get in touch
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-sm text-[#1a1a1a] mb-2 font-medium">What service are you interested in *</label>
                  <select name="service" value={formData.service} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-300 text-[#1a1a1a] focus:border-[#C4956A] outline-none transition-colors text-sm" required>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-[#1a1a1a] mb-2 font-medium">First Name</label>
                    <input type="text" name="firstName" value={formData.firstName} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-300 text-[#1a1a1a] placeholder-gray-400 focus:border-[#C4956A] outline-none transition-colors text-sm" required />
                  </div>
                  <div>
                    <label className="block text-sm text-[#1a1a1a] mb-2 font-medium">Surname</label>
                    <input type="text" name="surname" value={formData.surname} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-300 text-[#1a1a1a] placeholder-gray-400 focus:border-[#C4956A] outline-none transition-colors text-sm" required />
                  </div>
                </div>

                <div>
                  <label className="block text-sm text-[#1a1a1a] mb-2 font-medium">Email</label>
                  <input type="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-300 text-[#1a1a1a] placeholder-gray-400 focus:border-[#C4956A] outline-none transition-colors text-sm" required />
                </div>

                <div>
                  <label className="block text-sm text-[#1a1a1a] mb-2 font-medium">Telephone</label>
                  <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-300 text-[#1a1a1a] placeholder-gray-400 focus:border-[#C4956A] outline-none transition-colors text-sm" />
                </div>

                <div>
                  <label className="block text-sm text-[#1a1a1a] mb-2 font-medium">Your Message</label>
                  <textarea name="message" value={formData.message} onChange={handleChange} rows="5" className="w-full px-4 py-3 bg-white border border-gray-300 text-[#1a1a1a] placeholder-gray-400 focus:border-[#C4956A] outline-none transition-colors text-sm resize-none" />
                </div>

                <button type="submit" disabled={loading} className="inline-flex items-center gap-3 bg-[#1a1a1a] text-white px-10 py-4 text-sm tracking-wider uppercase hover:bg-[#333] disabled:opacity-50 transition-all duration-300">
                  {loading ? 'Sending...' : <><FiSend className="text-sm" /> Send Message</>}
                </button>
              </form>
            </div>
              ...
              <div className="space-y-12">
                ...
                <div>
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-2xl text-[#1a1a1a]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Find us</h3>
                  </div>
