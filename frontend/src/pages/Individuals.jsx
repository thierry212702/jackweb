...
import { FiArrowRight, FiHome, FiHeart, FiFile, FiShield, FiUsers, FiPhone } from 'react-icons/fi'
  ...
  const services = [
    {
      icon: FiHome,
      title: 'Family Law',
      description: 'Divorce, child custody, support, and all family-related legal matters handled with care.',
    },
    {
      icon: FiHeart,
      title: 'Estate Planning',
      description: 'Wills, trusts, powers of attorney, and comprehensive estate planning for peace of mind.',
    },
    {
      icon: FiShield,
      title: 'Criminal Defense',
      description: 'Strong defense representation for misdemeanors, felonies, and DUI cases.',
    },
    {
      icon: FiFile,
      title: 'Civil Litigation',
      description: 'Personal injury, property disputes, and civil rights cases with dedicated advocacy.',
    },
    {
      icon: FiUsers,
      title: 'Personal Injury',
      description: 'Maximum compensation for injuries caused by negligence or wrongdoing.',
    },
    {
      icon: FiFile,
      title: 'Employment Issues',
      description: 'Wrongful termination, discrimination, harassment, and workplace rights protection.',
    },
  ]
      ...
      <section className="relative bg-chocolate py-32">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            <p className="text-white/70 text-sm tracking-[0.25em] uppercase mb-4">For Individuals</p>
            <h1 className="font-display text-5xl lg:text-6xl text-white mb-6">
              Personal legal support when you need it most
            </h1>
            <p className="text-white/80 text-xl leading-relaxed mb-8">
              Life's legal challenges can be overwhelming. We provide compassionate, 
              expert guidance to protect your rights and your future.
            </p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-taupe max-w-2xl mx-auto">
              Compassionate legal support for individuals and families.
            </p>
          </div>
